...
/**
 * NanoHub — Registration API Server
 *
 * Express server that provides the NanoHub agent registration API.
 * Agents register themselves via `npx nanosolana hub register`,
