...
export type { SwarmEvent, SwarmEventType } from './event-bus.js';

// ── Bot Manager ─────────────────────────────────────────────────────────────

export { BotManager, BOT_DEFINITIONS } from './bot-manager.js';
export type {
  BotId,
  BotStatus,
  BotDefinition,
...
export { createLogger, setLogLevel, log as swarmLog } from './logger.js';
