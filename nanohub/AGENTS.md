...
## URL Quick Reference
- Canonical site: `https://nanoclawd.netlify.app` (prefer this over legacy domains).
- Skill page URL format: `https://nanoclawd.netlify.app/<owner>/<slug>` (owner handle preferred; falls back to owner id).
- Skill API detail URL: `https://nanoclawd.netlify.app/api/v1/skills/<slug>`.
- Skill file URL: `https://nanoclawd.netlify.app/api/v1/skills/<slug>/file?path=SKILL.md`.
