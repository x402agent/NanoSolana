...
CONVEX_DEPLOYMENT=anonymous:anonymous-nanohub
```
...
```bash
NANOHUB_REGISTRY=http://127.0.0.1:3210 NANOHUB_SITE=http://localhost:3000 nanohub search "padel"
```
...
```bash
nanohub publish <path-to-skill-directory>
```
