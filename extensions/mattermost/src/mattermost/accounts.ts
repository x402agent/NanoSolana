...
import { createAccountListHelpers, type NanoClawdConfig } from "nanoclawd/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: NanoClawdConfig): ResolvedMattermostAccount[] {
