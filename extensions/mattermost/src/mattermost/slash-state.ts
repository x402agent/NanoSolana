...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("nanoclawd/plugin-sdk/mattermost").NanoClawdConfig;
    runtime: import("nanoclawd/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: NanoClawdPluginApi) {
