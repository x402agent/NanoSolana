...
This directory contains the **BlueBubbles external channel plugin** for NanoClawd.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `nanoclawd/plugin-sdk` helpers.
