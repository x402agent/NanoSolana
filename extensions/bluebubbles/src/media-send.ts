...
import { resolveChannelMediaMaxBytes, type NanoClawdConfig } from "nanoclawd/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: NanoClawdConfig; accountId?: string }): string[] {
