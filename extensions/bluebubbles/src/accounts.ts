...
import { createAccountListHelpers, type NanoClawdConfig } from "nanoclawd/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: NanoClawdConfig): ResolvedBlueBubblesAccount[] {
