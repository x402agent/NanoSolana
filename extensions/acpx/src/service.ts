...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "nanoclawd/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: NanoClawdPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: NanoClawdPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
