import type { NanoClawdConfig, PluginRuntime, ResolvedLineAccount } from "nanoclawd/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: NanoClawdConfig; accountId: string }): Promise<{
