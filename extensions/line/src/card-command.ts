import type { LineChannelData, NanoClawdPluginApi, ReplyPayload } from "nanoclawd/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: NanoClawdPluginApi): void {
  api.registerCommand({
    name: "card",
