...
import { isSecretRef } from "nanoclawd/plugin-sdk/googlechat";
import { createAccountListHelpers, type NanoClawdConfig } from "nanoclawd/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: NanoClawdConfig): ResolvedGoogleChatAccount[] {
