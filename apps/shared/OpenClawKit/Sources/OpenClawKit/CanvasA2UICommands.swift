...
public enum NanoClawdCanvasA2UICommand: String, Codable, Sendable {
...
public struct NanoClawdCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NanoClawdCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
