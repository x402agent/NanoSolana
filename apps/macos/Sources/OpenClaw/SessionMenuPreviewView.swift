...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.nanoclawd", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> NanoClawdSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: NanoClawdSessionPreviewEntry,
    ...
    private static func cache(payload: NanoClawdSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: NanoClawdChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [NanoClawdKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [NanoClawdKit.AnyCodable]) -> [NanoClawdChatMessage] {
    ...
    private static func previewText(for message: NanoClawdChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: NanoClawdChatMessage) -> Bool {
    ...
    private static func toolNames(for message: NanoClawdChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: NanoClawdChatMessage) -> String? {
