...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nanoclawd", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NanoClawd/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nanoclawd__/a2ui/").absoluteString + "?platform=macos"
    }
