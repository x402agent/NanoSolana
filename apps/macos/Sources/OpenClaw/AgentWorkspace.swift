...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.nanoclawd", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NanoClawdConfigFile.defaultWorkspaceURL() }
