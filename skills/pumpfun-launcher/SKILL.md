...
Launch new tokens on the Pump.fun protocol using the native Pump SDK integrated into NanoClawd.

## Prerequisites

- Solana wallet configured (`nanoclawd birth`)
...
import { PUMP_SDK, OnlinePumpSdk, getBuyTokenAmountFromSolAmount } from "nanoclawd";
