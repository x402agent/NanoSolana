...
- Funded Solana wallet via `nanoclawd birth`
...
```typescript
import { OnlinePumpSdk, getBuyTokenAmountFromSolAmount } from "nanoclawd";
...
```typescript
import { getSellSolAmountFromTokenAmount } from "nanoclawd";
