...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.nanoclawd/nanoclawd.json`
...
- The script prints a `MEDIA:` line for NanoClawd to auto-attach on supported chat providers.
